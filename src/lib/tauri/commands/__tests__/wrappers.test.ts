...
const cases: TestCase[] = [
  ...
  { name: "aiVerifyOpenCodeAuthentication", run: () => ai.aiVerifyOpenCodeAuthentication(), expectedCommand: "ai_verify_opencode_authentication" },
  { name: "aiGetOpenCodeAuthStatus", run: () => ai.aiGetOpenCodeAuthStatus(), expectedCommand: "ai_get_opencode_auth_status" },
  { name: "aiCheckDroidCliAvailable", run: () => ai.aiCheckDroidCliAvailable(), expectedCommand: "ai_check_droid_cli_available" },
  { name: "aiVerifyDroidAuthentication", run: () => ai.aiVerifyDroidAuthentication(), expectedCommand: "ai_verify_droid_authentication" },
  { name: "aiGetDroidAuthStatus", run: () => ai.aiGetDroidAuthStatus(), expectedCommand: "ai_get_droid_auth_status" },
